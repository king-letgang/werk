...
module.exports = __webpack_require__(/*! D:\app\signin\src\main.ts */"zUnb");
...
/* harmony import */ var creditcardpayments_creditCardPayments__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! creditcardpayments/creditCardPayments */ "oAx0");
...
class AppComponent {
    constructor() {
        this.title = 'signin';
        Object(creditcardpayments_creditCardPayments__WEBPACK_IMPORTED_MODULE_0__["render"])({
            id: "#myPaypalButtons",
            currency: "USD",
            value: "100.00",
            onApprove: (details) => {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 1, vars: 0, consts: [["id", "myPaypalButtons"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
